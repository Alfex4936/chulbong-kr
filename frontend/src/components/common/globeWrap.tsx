      ...
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden md:h-[40rem] px-4">
        ...
        >
          ...
          >
            ...
            <span
              data-testid="nav-btn"
              className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-slate-950 px-4 py-0 text-sm font-medium text-white backdrop-blur-3xl"
            >
              철봉 지도 바로 가기
            </span>
          </button>
